...
Gem::Specification.new do |s|
  ...
  s.homepage    = 'https://github.com/ministry-of-code/twisted-caldav'
  s.authors     = ['Siddhartha Mukherjee', 'Marko Kind']
  s.email       = ['mukherjee.siddhartha@gmail.com', 'marko@ministry-of-co.de']
